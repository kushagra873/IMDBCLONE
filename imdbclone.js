...
fetch('http://www.omdbapi.com/?i=tt3896198&apikey=c7f07a11')
    .then(res => res.json())
...
async function removeFromfavorites(id) {
    ...
    window.location.replace('favmovies.html');
}
        ...
        <div class="fav-item">
            ...
            <div class="fav-details">
                <div class="fav-details-box">
                    <div>
                        <p class="fav-movie-name"><a href="movies.html?id=${id}">${i.Title}</a></p>
                        <p class="fav-movie-rating"><a href="movies.html?id=${id}">${i.Year}</a></p>
                    </div>
                    <div>
